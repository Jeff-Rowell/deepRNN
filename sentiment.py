...
counts = Counter()
pbar = pyprind.ProgBar(len(df['review']), title='Counting word occurrences')
...
## Create a mapping and map each unique word to an integer
...
## Define same-length sequences, if sequence length < 200: left-pad with zeros
